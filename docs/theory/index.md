...
| [Identification and Anchors](identification.md) | What is recoverable from behavior alone, and what does an anchor action add? | NFXP, CCP, TD-CCP, AIRL2, GLADIUS. |
| [Classical DDC Proof Routes](classical_ddc.md) | How do NFXP, CCP, and TD-CCP enforce the identifying equations? | NFXP, CCP, TD-CCP. |
| [IRL Identification Boundaries](irl_boundaries.md) | What do MCE-IRL, AIRL, GAIL, and IQ-Learn identify? | MCE-IRL, Neural MCE-IRL, AIRL, AIRL2, IQ-Learn. |
...
| [Reward Projection and Feature Rank](reward_projection.md) | When does a recovered reward imply a finite parameter vector? | NFXP, CCP, TD-CCP, MCE-IRL, Neural MCE-IRL, AIRL2, GLADIUS. |
