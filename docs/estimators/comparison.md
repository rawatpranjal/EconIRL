...
page. NFXP is the reference. Every other estimator answers one source of
complexity that breaks NFXP's canonical case, as set out in
...
Ordered by the source of complexity each one answers.
