...
The results file records these pre-estimation checks.
...
The canonical cell is intentionally small enough that the value-function
constraint is inspectable, while still requiring recovery of reward, policy,
value, Q, and counterfactual oracle objects.
...
orientation can produce plausible arrays and wrong economics.
