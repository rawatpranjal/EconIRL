...
EconIRL supports the following estimators: 
...
See `Comparing and Choosing Estimators <comparing_estimators.html>`__ for a focused comparison of core estimators. 

Replications
------------

To ensure the estimators are working as intended we carry out replications and match EconIRL's results with those found in key papers.

You can find this in `Replications <replications.html>`__  .
