"""GCL validation companion script.

Runs GCL alongside MCE-IRL on a 5x5 gridworld and writes
results to the package validation results directory.

Usage:
    python validation/estimators/gcl/run.py
"""
...
def main():
    ...
    path = Path(__file__).resolve().parents[3] / "validation" / "results" / "gcl.json"
