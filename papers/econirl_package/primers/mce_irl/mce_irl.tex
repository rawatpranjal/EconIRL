...
We run MCE-IRL, NFXP, and behavioral cloning on a \mceGridSize$\times$\mceGridSize\ gridworld with \mceNstates\ states, 5 actions, and three action-dependent features (step penalty, terminal reward, distance weight). Data consists of \mceNobs\ observations from \mceGridSize00 simulated trajectories at $\beta = \mceBeta$.
