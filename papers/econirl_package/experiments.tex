...
IQ-Learn achieves lower log-likelihood than NFXP ($-4678$ versus $-4263$) because the $\ell^2$ reward penalty trades fit for a smaller implied reward, as predicted by the penalized MLE equivalence in Appendix~\ref{sec:iq_learn}.
