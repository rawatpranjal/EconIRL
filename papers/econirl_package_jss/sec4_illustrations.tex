...
\begin{lstlisting}[style=econirlpython,caption={Fitting the nested fixed point estimator on the Rust bus panel. Reproduced by \code{code\_snippets/listing2\_nfxp\_example.py}.},label={lst:nfxp}]
...
\begin{lstlisting}[style=econirlpython,caption={Fitting MCE-IRL on the same Rust bus panel. Reproduced by \code{code\_snippets/listing3\_mce\_irl\_example.py}.},label={lst:mce}]
...
\begin{lstlisting}[style=econirlpython,caption={Fitting NNES on the Keane-Wolpin occupational choice panel. Reproduced by \code{code\_snippets/listing4\_nnes\_example.py}.},label={lst:nnes}]
