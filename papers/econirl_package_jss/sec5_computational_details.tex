...
\end{quote}
The development version with optional testing dependencies installs through \code{pip install "econirl[dev]"}. The package documentation is hosted at \url{https://econirl.readthedocs.io/en/latest/index.html}.
