"""TT4 transfer test for IQ-Learn. The implicit reward recovered from the
soft Q-function is evaluated under perturbed transitions.

Reproduces: row TT4 of transfer_results.csv.
"""
...
est = IQLearnEstimator(config=IQLearnConfig(q_type="linear", divergence="chi2", optimizer="L-BFGS-B", max_iter=500))
...
row = {"estimator": "IQ-Learn", "percent_transfer_value": f"{pct:.2f}"}
