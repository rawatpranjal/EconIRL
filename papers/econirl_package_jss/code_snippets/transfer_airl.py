"""TT3 transfer test for AIRL. The disentangled reward parameterization is
designed to transfer across transition structures.

Reproduces: row TT3 of transfer_results.csv.
"""
...
est = AIRLEstimator(config=AIRLConfig(reward_type="linear", max_rounds=100, generator_solver="hybrid"))
...
row = {"estimator": "AIRL", "percent_transfer_value": f"{pct:.2f}"}
